...
and command it in CoppeliaSim (V-REP). It offers a command line option interface. To see
all the options, in a terminal type

    python lbr4_trajopt.py -h

If you wanted to run problem 1.1 with default values, you would type
